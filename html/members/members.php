...
<body>
   ...
   <?php include '../includes/logo.inc'; ?> 
      ...
      <div id="cart">
      <?php $shoppingCart = new cart; 
      $i = $shoppingCart->getCartCount();
      if ($i == 1){
         echo '<p>'.$i.' '. '<a href="cart.php">Item In Cart</a>';
      }else{
         echo '<p>'.$i.' '. '<a href="cart.php">Items In Cart</a>';
      };?> 
      </div>
      <div id="breadcrumbs" class="PageContainer">
         <a href="../../index.php">Home</a>
         <p>></p>
         <a href="members.php">Member's Area</a>
      </div>
      <div class="PageContainer tac">
         <div id="contentContainer" class="">
            <h1>Member's Area</h1>
         <div id="catalogueContainer" class="addFiftyBottom">
         <?php
         if( isset($_SESSION["logged_in"]) ){
